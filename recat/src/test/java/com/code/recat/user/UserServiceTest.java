...
public class UserServiceTest {
    ...
    void setup (){
         users = List.of(
                new User(99, "Kolade Amire", "koladeam", "koladeamire20@gmail.com", "M", "1234567890Kolade@", "admin"),
    ...
    void shouldCreateANewUser(){
        ...
        User newUser = new User(99, "Kolade Amire", "koladeam", "koladeamire20@gmail.com", "M", "1234567890Kolade@", "admin");
